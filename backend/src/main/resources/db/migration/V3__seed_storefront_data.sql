...
('01111111-1111-1111-1111-111111111111', 'Franklin Canduri', 'franklin@example.com', '12345678901', '11987654321', 'Rua das Flores', '123', 'Centro', 'São Paulo', 'SP', '01234567', true),
('02222222-2222-2222-2222-222222222222', 'Maria Silva', 'maria.silva@example.com', '98765432109', '11876543210', 'Av. Paulista', '1000', 'Bela Vista', 'São Paulo', 'SP', '01310100', true),
('03333333-3333-3333-3333-333333333333', 'João Santos', 'joao.santos@example.com', '11122233344', '11765432109', 'Rua Augusta', '500', 'Consolação', 'São Paulo', 'SP', '01305000', true);

-- =====================================================
-- CARRINHOS DE EXEMPLO (ATIVOS)
-- =====================================================
INSERT INTO carrinhos_compras (id, cliente_id, status) VALUES
('0a111111-1111-1111-1111-111111111111', '01111111-1111-1111-1111-111111111111', 'ATIVO'),
('0a222222-2222-2222-2222-222222222222', '02222222-2222-2222-2222-222222222222', 'ATIVO');
...
('0a111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 1, 3499.99),
('0a111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 1, 449.90),
('0a111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 2, 89.90),

-- Carrinho da Maria
('0a222222-2222-2222-2222-222222222222', '99999999-9999-9999-9999-999999999999', 1, 1799.00),
('0a222222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 1, 189.90);
...
('11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Notebook Dell Inspiron 15', 1, 3499.99),
('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', 'Mouse Logitech MX Master 3', 1, 449.90),
('11111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', 'Clean Code - Robert C. Martin', 2, 89.90),
('11111111-1111-1111-1111-111111111111', '77777777-7777-7777-7777-777777777777', 'Domain-Driven Design - Eric Evans', 2, 129.90),

-- Pedido PED-20251015-00002 (Franklin)
('22222222-2222-2222-2222-222222222222', '99999999-9999-9999-9999-999999999999', 'Fone de Ouvido Sony WH-1000XM5', 1, 1799.00),
('22222222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Mochila para Notebook Targus 15.6"', 1, 189.90);

-- =====================================================
-- COMENTÁRIOS
-- =====================================================
-- Contém 10 produtos de exemplo em categorias variadas
-- Contém 3 clientes de exemplo
-- Contém 2 carrinhos ativos com itens
-- Contém 2 pedidos de exemplo em diferentes status
